...
func (m *mockAmpExchange) HoldAuction(ctx context.Context, bidRequest *adscert.BidRequest, ids exchange.IdFetcher, labels pbsmetrics.Labels) (*openrtb.BidResponse, error) {
