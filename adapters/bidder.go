...
type Bidder interface {
	...
	MakeRequests(request *adscert.BidRequest) ([]*RequestData, []error)
	...
	MakeBids(internalRequest *adscert.BidRequest, externalRequest *RequestData, response *ResponseData) (*BidderResponse, []error)
}
