...
func (a *auction) doCache(ctx context.Context, cache prebid_cache_client.Client, bids bool, vast bool, bidRequest *adscert.BidRequest, ttlBuffer int64, defaultTTLs *config.DefaultTTLs) []error {
	if !bids && !vast {
		return nil
	}
