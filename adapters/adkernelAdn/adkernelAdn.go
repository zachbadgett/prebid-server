...
func (adapter *adkernelAdnAdapter) MakeRequests(request *adscert.BidRequest) ([]*adapters.RequestData, []error) {
...
func (adapter *adkernelAdnAdapter) buildAdapterRequest(prebidBidRequest *adscert.BidRequest, params *openrtb_ext.ExtImpAdkernelAdn, imps []openrtb.Imp) (*adapters.RequestData, error) {
...
func createBidRequest(prebidBidRequest *adscert.BidRequest, params *openrtb_ext.ExtImpAdkernelAdn, imps []openrtb.Imp) *adscert.BidRequest {
...
func (adapter *adkernelAdnAdapter) MakeBids(internalRequest *adscert.BidRequest, externalRequest *adapters.RequestData, response *adapters.ResponseData) (*adapters.BidderResponse, []error) {
